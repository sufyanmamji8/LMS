...
export const dummyCourses = [
    {
        ...
        "courseTitle": "Introduction to JavaScript",
        "courseDescription": "<h2>Learn the Basics of JavaScript</h2><p>JavaScript is a versatile programming language that powers the web. In this course, you will learn the fundamentals of JavaScript, including syntax, data types, and control structures.</p><p>This course is perfect for beginners who want to start their journey in web development. By the end of this course, you will be able to create interactive web pages and understand the core concepts of JavaScript.</p><ul><li>Understand the basics of programming</li><li>Learn how to manipulate the DOM</li><li>Create dynamic web applicationsJavaScript follows the ECMAScript standard, which defines its syntax and core features. Over time, it has evolved from a simple client-side scripting tool into a powerful, multi-paradigm language capable of supporting procedural, object-oriented, and functional programming styles. With the introduction of Node.js in 2009, JavaScript expanded its capabilities to the server side, enabling developers to build full-stack applications using the same language for both front-end and back-end developmen</li></ul>",
        "coursePrice": 49.99,
        "isPublished": true,
        "discount": 20,
        "courseContent": [
